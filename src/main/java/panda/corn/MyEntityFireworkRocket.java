...
public class MyEntityFireworkRocket extends Entity{
	...
	private static final DataParameter<Optional<ItemStack>> FIREWORK_ITEM = EntityDataManager.<Optional<ItemStack>>createKey(MyEntityFireworkRocket.class, DataSerializers.OPTIONAL_ITEM_STACK);
	...
	public void handleStatusUpdate(byte id)
	{
		if (id == 17 && this.worldObj.isRemote)
		{
			...
			Minecraft.getMinecraft().effectRenderer.addEffect(EntityParticlePopcornFX.generatePopcornParticles(worldObj, this.posX, this.posY, this.posZ, this.motionX, this.motionY, this.motionZ, nbttagcompound, fireworkAge)); 
		}
