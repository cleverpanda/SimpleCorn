...
public class Corn {
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		...
		Item itemCob = (new ItemCornCob(2, 3.6F,false).setUnlocalizedName("corncob"));
		GameRegistry.registerItem(itemCob, "corncob");

		Item itemRoasted = (new ItemRoastedCorn(8, 10F,false).setUnlocalizedName("roastedcorn"));
		GameRegistry.registerItem(itemRoasted, "roastedcorn");

		Item chowder = (new ItemCornChowder(6,7.2F).setUnlocalizedName("cornchowder"));
		GameRegistry.registerItem(chowder, "cornchowder");

		Item chickenchowder = (new ItemCornChowder(10,9.6F).setUnlocalizedName("chickencornchowder"));
